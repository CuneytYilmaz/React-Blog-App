...
describe('asyncValidation', function () {
  ...
  it('should throw an error if fn does not return a promise', function () {
    ...
    _expect2['default'](function () {
      return _asyncValidation2['default'](fn, start, stop, field);
    }).toThrow(/promise/);
  });
  ...
  it('should return a promise', function () {
    ...
    _expect2['default'](_isPromise2['default'](_asyncValidation2['default'](fn, start, stop, field))).toBe(true);
  });
  ...
  it('should call start, fn, and stop on promise resolve', function () {
    ...
    var promise = _asyncValidation2['default'](fn, start, stop, field);
    _expect2['default'](fn).toHaveBeenCalled();
    _expect2['default'](start).toHaveBeenCalled().toHaveBeenCalledWith(field);
